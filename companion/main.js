...
const UpdatePresets = require('./presets') // <-- ADDED
...
const NET_LEAVES = ['carrier', 'duplex', 'gateway', 'ip_address', 'mac_address', 'net_mask', 'speed'] // variables names follow status_network_{iface}_{leaf}
...
class ModuleInstance extends InstanceBase {
  ...
  _onSubLine(line) {
    ...
    if (fpl) {
      ...
      this.checkFeedbacks('front_panel_lockout_state')
      return
    }
  }
  ...
  updatePresets() {
    UpdatePresets(this, NUM_INPUTS, NUM_OUTPUTS) // <-- ADDED
  }
